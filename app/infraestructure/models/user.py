...
class User(Base):
    ...
    global_role: Mapped[GlobalRole] = mapped_column(Enum(GlobalRole, name="globalrole", create_type=False), default=GlobalRole.ADMIN, server_default="ADMIN", nullable=False)
